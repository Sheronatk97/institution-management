...
//     try {
//       const response = await axios.get('http://localhost:3000/api/designers/all');
...
//     try {
//       if (selectedDesigner) {
//         await axios.put(`http://localhost:3000/api/designers/update/${selectedDesigner._id}`, values);
//         message.success('Designer updated successfully');
//       } else {
//         await axios.post('http://localhost:3000/api/designers/create', values);
...
//     try {
//       await axios.delete(`http://localhost:3000/api/designers/delete/${id}`);
...
//           </Form.Item>
//           <Form.Item name="password" label="Password" rules={[{ required: true, message: 'Please enter password' }, { type: 'password', message: 'Enter a valid password' }]}> 
...
// export default DesignerCreationForm;
